...
<style>
    ...
    /* Icon chìm làm nền: Bảo trì/Sửa chữa */
    .bg-icon-watermark {
        position: absolute;
        top: 50%;
        left: 50%;
...
<div class="error-page-wrapper">
    ...
    <div class="container">
        <div class="error-card">
            ...
            <h2 class="error-title">Bảo trì hệ thống</h2>
            
            <p class="error-desc">
                Chúng tôi đang tạm dừng dịch vụ để nâng cấp trải nghiệm.<br>
                Hệ thống sẽ sớm hoạt động trở lại. Cảm ơn sự kiên nhẫn của quý khách!
            </p>

            <div class="action-buttons">
                <a href="{{ url('/') }}" class="btn-custom btn-gold">
                    <i class="fa-solid fa-bell mr-2"></i> Thông báo cho tôi khi xong
                </a>
            </div>
        </div>
    </div>
