@extends('layouts.app')
@section('title', '419 — Phiên đã hết hạn')
...
<div class="error-page-wrapper">
    ...
    <div class="container">
        <div class="error-card">
            ...
            <h2 class="error-title">Phiên đã hết hạn</h2>
            
            <p class="error-desc">
                Phiên làm việc của bạn đã hết thời gian chờ.<br>
                Điều này thường xảy ra khi bạn ở trên trang quá lâu. Vui lòng làm mới trang để tiếp tục.
            </p>

            <div class="action-buttons">
                <a href="{{ url()->current() }}" class="btn-custom btn-gold">
                    <i class="fa-solid fa-sync-alt mr-2"></i> Làm mới trang
                </a>
