...
<style>
    ...
    /* Icon chìm làm nền: Vượt quá giới hạn tốc độ */
    .bg-icon-watermark {
        position: absolute;
        top: 50%;
        left: 50%;
...
<div class="error-page-wrapper">
    ...
    <div class="container">
        <div class="error-card">
            ...
            <p class="error-desc">
                Hệ thống nhận thấy bạn đang gửi quá nhiều yêu cầu trong một khoảng thời gian ngắn.<br>
                Vui lòng đợi vài phút rồi **làm mới trang** để truy cập lại.
            </p>

            <div class="action-buttons">
                <a href="{{ url()->current() }}" class="btn-custom btn-gold">
                    <i class="fa-solid fa-sync-alt mr-2"></i> Thử lại ngay
                </a>
