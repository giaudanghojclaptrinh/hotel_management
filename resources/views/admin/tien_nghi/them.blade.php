...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-serif font-bold text-white">Thông tin tiện nghi</h1>
    ...
    <div class="bg-gray-900 rounded-2xl shadow-lg border border-gray-800 overflow-hidden">
        ...
        <div class="bg-gray-800/50 px-8 py-4 border-b border-gray-800">
            <h3 class="text-sm font-bold text-brand-gold uppercase tracking-wider">Tạo tiện nghi mới</h3>
        </div>
        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('admin.tien-nghi.store') }}">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-400 mb-2">Mã tiện nghi (Code) <span class="text-red-500">*</span></label>
                        ...
                        <p class="text-xs text-gray-500 mt-2">Dùng để định danh trong hệ thống (nên viết liền không dấu).</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-4 items-start">
                            ...
                            <div class="w-11 h-11 flex-shrink-0 flex items-center justify-center bg-gray-800 rounded-lg shadow-sm border border-gray-700 text-brand-gold text-xl transition-all" id="iconPreviewBox">
                    ...
                    <div class="pt-6 border-t border-gray-800 flex items-center justify-end gap-3">
                        ...
                        <button type="submit" class="px-6 py-2.5 bg-brand-gold text-gray-900 rounded-lg font-bold hover:bg-white shadow-md transition-all flex items-center">
                            <i class="fa-solid fa-plus mr-2"></i> Tạo Tiện Nghi
                        </button>
                    </div>
                </div>
            </form>
