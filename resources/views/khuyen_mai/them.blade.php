...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="card-common p-6">
        ...
        <form action="{{ route('khuyen-mai.them') }}" method="POST">
            @csrf
            <div class="grid grid-cols-1 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700" for="ten_khuyen_mai">Tên khuyến mãi</label>
                    <input type="text" id="ten_khuyen_mai" name="ten_khuyen_mai" value="{{ old('ten_khuyen_mai') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-brand-900 focus:border-brand-900" />
                ...
                <div>
                    ...
                    <input type="text" id="ma_khuyen_mai" name="ma_khuyen_mai" value="{{ old('ma_khuyen_mai') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-brand-900 focus:border-brand-900" />
                ...
                <div>
                    ...
                    <input type="number" step="0.01" id="chiet_khau_phan_tram" name="chiet_khau_phan_tram" value="{{ old('chiet_khau_phan_tram') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-brand-900 focus:border-brand-900" />
                ...
                <div>
                    ...
                    <input type="number" step="0.01" id="so_tien_giam_gia" name="so_tien_giam_gia" value="{{ old('so_tien_giam_gia') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-brand-900 focus:border-brand-900" />
                ...
                <div>
                    ...
                    <input type="date" id="ngay_bat_dau" name="ngay_bat_dau" value="{{ old('ngay_bat_dau') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-brand-900 focus:border-brand-900" />
                ...
                <div>
                    ...
                    <input type="date" id="ngay_ket_thuc" name="ngay_ket_thuc" value="{{ old('ngay_ket_thuc') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-brand-900 focus:border-brand-900" />
