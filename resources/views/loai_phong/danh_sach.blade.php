...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="toolbar mb-6">
        ...
        <a href="{{ route('loai-phong.them') }}" class="btn-primary inline-flex items-center gap-2 text-sm font-semibold">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm text-center">
                            <a href="{{ route('loai-phong.sua', ['id' => $lp->id]) }}" class="text-blue-600 hover:text-blue-800 mr-3" title="Sửa"><i class="fa fa-edit"></i></a>
                            <a href="{{ route('loai-phong.xoa', ['id' => $lp->id]) }}" onclick="return confirm('Bạn có muốn xóa loại phòng {{ $lp->ten_loai_phong }} không?')" class="text-red-600 hover:text-red-800" title="Xóa"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
